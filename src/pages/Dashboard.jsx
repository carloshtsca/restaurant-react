            ...
            <div className='container mx-auto flex items-center justify-between py-14 px-6 md:px-4'>
                        ...
                        return (
                            <button
                                ...
                                className='bg-[#1a1a1a] hover:bg-[#262626] px-8 py-3
                                    rounded-lg text-[#f5f5f5] font-semibold text-md flex 
                                    items-center gap-2'
                            >
                                {label} {icon}
                            </button>
                ...
                <div className='flex items-center gap-3'>
                    {tabs.map((tab) => {
                        return (
                            <button
                                className={`bg-[#1a1a1a] hover:bg-[#262626] px-8 py-3 rounded-lg 
                                text-[#f5f5f5] font-semibold text-md flex items-center gap-2 
