...
const MenuContainer = () => {
    ...
    return (
        <>
            <div className='grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 px-10 py-4 w-[100%]'>
                {
                    menus.map((menu) => {
                        return (
                            <div
                        ...
                        return (
                            <div key={menu.id} className='flex flex-col items-start justify-between p-4 rounded-lg h-[150px] cursor-pointer hover:bg-[#2a2a2a] bg-[#1a1a1a]'>
                                ...
                                <div className='flex items-center justify-between w-full'>
                                    ...
                                    <div className='flex items-center justify-between bg-[#1f1f1f] px-4 py-3 rounded-lg gap-6 w-32'>
